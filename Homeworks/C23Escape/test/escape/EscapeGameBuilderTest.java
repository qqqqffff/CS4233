...
public class EscapeGameBuilderTest {
    ...
    EscapeGameBuilderTest() throws Exception {
        ...
        hex_coord_test_builder = new EscapeGameBuilder("test/escape_configs/escape_hex_coord_test.egc");
    ...
    public void testCoordinateHex2(){
        assertEquals(hex_coord_test_builder.getGameInitializer().getLocationInitializers()[0].locationType, LocationType.CLEAR);
